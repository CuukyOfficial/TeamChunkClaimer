...
public class ChunkTeam implements CFWSerializeable {
    ...
    public void addMember(ChunkPlayer player, TeamMemberType memberType) {
        ...
        AdvancedInventoryManager manager = this.handler.getClaimer().getCuukyFrameWork().getAdvancedInventoryManager();
        manager.updateInventories(TeamMemberMenu.class, TeamMainMenu.class);
    }
    ...
    public void addChunk(Chunk chunk, ChunkPlayer claimedBy) {
        ...
        AdvancedInventoryManager manager = this.handler.getClaimer().getCuukyFrameWork().getAdvancedInventoryManager();
        manager.updateInventories(ChunkMapMenu.class, ChunkListMenu.class, TeamMainMenu.class);
    }
    ...
    public void setFlag(ChunkFlag flag, boolean enabled) {
        ...
        this.handler.getClaimer().getCuukyFrameWork().getAdvancedInventoryManager().updateInventories(FlagOptionsMenu.class);
    }
    ...
    public void setName(String name) {
        ...
        this.handler.getClaimer().getCuukyFrameWork().getAdvancedInventoryManager().updateInventories(GeneralOptionsMenu.class);
    }
